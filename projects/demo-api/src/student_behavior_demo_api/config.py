...
def build_default_settings(repo_root: Path) -> DemoApiSettings:
    ...
    return DemoApiSettings(
        ...
        overview_json=artifacts_root / "v1_overview_by_term.json",
        model_summary_json=artifacts_root / "v1_model_summary.json",
        warnings_json=artifacts_root / "v1_warnings.json",
        default_page=1,
